    ...
    <div className="h-[10%] fixed bottom-0 w-full text-white bg-[#181818] p-2">
      <div className="flex flex-col sm:flex-row items-center justify-between px-4 gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <img src={songsData[0].image} className="w-[45px] sm:w-[55px]" alt="" />
        ...
        <div className="flex flex-col items-center gap-2 w-full sm:w-auto">
          ...
          <div className="flex gap-3">
            ...
            <img src={assets.play_icon} className="w-[20px] sm:w-[25px] cursor-pointer" alt="" />
          ...
          <div className="flex gap-2 items-center w-full justify-center">
            ...
            <div className="bg-white w-[40vw] max-[995px]:w-[30vw] sm:w-[60vw] max-w-[300px] sm:max-w-[500px] cursor-pointer relative">
              <div className="h-1 w-1/3 bg-green-700 rounded-full"></div>
            </div>
